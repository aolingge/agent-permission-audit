...
function help() {
  console.log(`agent-permission-audit v0.1.0

Usage:
  agent-permission-audit --path FILE
  agent-permission-audit FILE --markdown
  agent-permission-audit FILE --sarif > results.sarif
  agent-permission-audit FILE --annotations
  agent-permission-audit FILE --redact
`)
}
...
try {
  ...
  console.error(`agent-permission-audit: ${error.message}`)
  process.exit(2)
}
